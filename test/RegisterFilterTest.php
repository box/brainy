...
class RegisterFilterTest extends Smarty_TestCase
{
    ...
    */
    public function testRegisterPrefilterFunction() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_PRE,'myfilter');
    ...
    */
    public function testRegisterPrefiltermethod() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_PRE, array('myfilterclass','execute'));
    ...
    */
    public function testRegisterPrefilterObject() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_PRE, array(new myfilterclass,'execute'));
        $this->assertTrue(is_callable($this->smarty->registered_filters['pre']['myfilterclass_execute']));
    }
    /**
    ...
    */
    public function testUnegisterPrefilterFunction() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_PRE,'myfilter');
        $this->smarty->unregisterFilter(\Box\Brainy\Brainy::FILTER_PRE,'myfilter');
    ...
    */
    public function testUnregisterPrefiltermethod() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_PRE, array('myfilterclass','execute'));
        $this->smarty->unregisterFilter(\Box\Brainy\Brainy::FILTER_PRE,array('myfilterclass','execute'));
    ...
    */
    public function testRegisterPostfilterFunction() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_POST,'myfilter');
    ...
    */
    public function testRegisterPostfiltermethod() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_POST, array('myfilterclass','execute'));
    ...
    */
    public function testUnegisterPostfilterFunction() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_POST,'myfilter');
        $this->smarty->unregisterFilter(\Box\Brainy\Brainy::FILTER_POST,'myfilter');
    ...
    */
    public function testUnregisterPostfiltermethod() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_POST, array('myfilterclass','execute'));
        $this->smarty->unregisterFilter(\Box\Brainy\Brainy::FILTER_POST,array('myfilterclass','execute'));
    ...
    */
    public function testRegisterOutputfilterFunction() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_OUTPUT,'myfilter');
    ...
    */
    public function testRegisterOutputfiltermethod() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_OUTPUT, array('myfilterclass','execute'));
    ...
    */
    public function testUnegisterOutputfilterFunction() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_OUTPUT,'myfilter');
        $this->smarty->unregisterFilter(\Box\Brainy\Brainy::FILTER_OUTPUT,'myfilter');
    ...
    */
    public function testUnregisterOutputfiltermethod() {
        $this->smarty->registerFilter(\Box\Brainy\Brainy::FILTER_OUTPUT, array('myfilterclass','execute'));
        $this->smarty->unregisterFilter(\Box\Brainy\Brainy::FILTER_OUTPUT,array('myfilterclass','execute'));
