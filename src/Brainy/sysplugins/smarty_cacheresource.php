...
abstract class Smarty_CacheResource
{
     ...
     *
     * @param Smarty $smarty Smarty object
     * @param Smarty_Template_Cached $cached A cached template
     * @return null|boolean Returns whether the resource is locked
     */
     ...
     * @param Smarty $smarty Smarty object
     * @param Smarty_Template_Cached $cached A cached template
     * @return boolean Returns whether the resource is locked
     */
     ...
     * @param Smarty $smarty Smarty object
     * @param Smarty_Template_Cached $cached A cached template
     * @return boolean Returns whether the lock was acquired
     */
     ...
     * @param Smarty $smarty Smarty object
     * @param Smarty_Template_Cached $cached A cached template
     * @return boolean Returns whether the lock was released
     */
